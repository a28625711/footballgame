...
ENV_JS = '''
var _mk=function(){return {style:{},children:[],classList:{add:function(){},remove:function(){},toggle:function(){},contains:function(){return false}},innerHTML:'',textContent:'',value:'',checked:false,appendChild:function(){},setAttribute:function(){},getAttribute:function(){return null},querySelector:function(){return null},querySelectorAll:function(){return []},closest:function(){return null},addEventListener:function(ev,fn){var s=this;(s.__ev=s.__ev||{})[ev]=(s.__ev[ev]||[]).concat([fn]);},getBoundingClientRect:function(){return {top:0,height:0}}};};
var window={scrollTo:function(){},scrollBy:function(){},__L:[],__ELS:{}};
var document={getElementById:function(id){var e=window.__ELS[id];if(!e){e=_mk();e.id=id;window.__ELS[id]=e;}return e;},querySelector:function(){return _mk();},querySelectorAll:function(){return [];},createElement:function(){return _mk();},addEventListener:function(ev,fn){var w=window;(w.__DOCEV=w.__DOCEV||{})[ev]=(w.__DOCEV[ev]||[]).concat([fn]);},body:{appendChild:function(){},querySelector:function(){return null;},querySelectorAll:function(){return [];},classList:{add:function(){},remove:function(){},toggle:function(){},contains:function(){return false;}}},documentElement:{style:{}}};
