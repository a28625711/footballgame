...
a6["simulate"+"OneSeaso"+'n'],a6["doTransf"+'er'],a6["pickOffe"+'rs'],a6["offerOpt"+"ion"],a6["buildPro"+"profile"]);
var _ptNames_=['射手','组织核心','全能','速度型','支点','影锋','B2B','铁腰','边后卫','自由人','铁卫','门将'];
function ar(){
